...
#define MODBUS_ENOBASE                  0x10000000
...
extern void *port_modbus_malloc(uint32_t size);
extern void port_modbus_free( void *addr);
...
MODBUS_API int modbus_get_response_timeout(modbus_t *ctx, uint32_t *timeout);
MODBUS_API int modbus_set_response_timeout(modbus_t *ctx, uint32_t timeout);

MODBUS_API int modbus_get_byte_timeout(modbus_t *ctx, uint32_t *timeout);
MODBUS_API int modbus_set_byte_timeout(modbus_t *ctx, uint32_t timeout);

MODBUS_API int modbus_get_indication_timeout(modbus_t *ctx, uint32_t *timeout);
MODBUS_API int modbus_set_indication_timeout(modbus_t *ctx, uint32_t timeout);

MODBUS_API int modbus_get_header_length(modbus_t *ctx);

MODBUS_API int modbus_connect(modbus_t *ctx);
MODBUS_API int modbus_close(modbus_t *ctx);
...
MODBUS_API int modbus_write_registers_check_callback(modbus_t *ctx,int addr_offset,const uint8_t *value,int cnt);
