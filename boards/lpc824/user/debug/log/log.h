...
#define LOG_ARRAY_PREFIX   LOG_ARRAY_COLOR   LOG_TIME_STRING 
...
#define log_array(format,arg...)                                                          \
    if ((LOG_MODULE_LEVEL >= LOG_LEVEL_ARRAY) &&                                          \
        (LOG_LEVEL_ARRAY <= LOG_GLOBAL_LEVEL))                                            \
    {                                                                                     \
     LOG_OUT(LOG_ARRAY_PREFIX format,LOG_TIME_VALUE,##arg);                               \
    }    
