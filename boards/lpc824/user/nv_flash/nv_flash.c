...
#define  NV_FLASH_SECTOR_SIZE_BYTES                         1024
#define  NV_FLASH_PAGE_SIZE_BYTES                           64

#define  NV_FLASH_SECTOR_CNT                                32   
#define  NV_FLASH_USER_DATA_SECTOR_BANK1_OFFSET             31  
#define  NV_FLASH_USER_DATA_SECTOR_BANK1_CNT                1
#define  NV_FLASH_USER_DATA_SECTOR_BANK2_OFFSET             30   
#define  NV_FLASH_USER_DATA_SECTOR_BANK2_CNT                1

#define  NV_FLASH_USER_DATA_PAGE_CNT_PER_SECTOR             (NV_FLASH_SECTOR_SIZE_BYTES / NV_FLASH_PAGE_SIZE_BYTES)  
#define  NV_FLASH_USER_DATA_SIZE                            56
...
/*当前数据块指针*/
static nv_flash_block_t *start_addr_bank1 = (nv_flash_block_t *)(NV_FLASH_USER_DATA_SECTOR_BANK1_OFFSET * NV_FLASH_SECTOR_SIZE_BYTES);
static nv_flash_block_t *end_addr_bank1 = (nv_flash_block_t *)((NV_FLASH_USER_DATA_SECTOR_BANK1_OFFSET + NV_FLASH_USER_DATA_SECTOR_BANK1_CNT) * NV_FLASH_SECTOR_SIZE_BYTES);
static nv_flash_block_t *start_addr_bank2 = (nv_flash_block_t *)(NV_FLASH_USER_DATA_SECTOR_BANK2_OFFSET * NV_FLASH_SECTOR_SIZE_BYTES);
static nv_flash_block_t *end_addr_bank2 = (nv_flash_block_t *)((NV_FLASH_USER_DATA_SECTOR_BANK2_OFFSET + NV_FLASH_USER_DATA_SECTOR_BANK2_CNT) * NV_FLASH_SECTOR_SIZE_BYTES);
...
/*
* @brief nv_flash_is_blank_region 检测是否为空白块
* @param region 区域类型
* @return true：是空白的 flase：不是
* @note
*/
static bool nv_flash_is_blank_region(nv_flash_region_t region)
{
    ...
    if (region == NV_FLASH_REGION_BANK1) {
        status = FLASHIAP_BlankCheckSector(NV_FLASH_USER_DATA_SECTOR_BANK1_OFFSET,NV_FLASH_USER_DATA_SECTOR_BANK1_OFFSET + NV_FLASH_USER_DATA_SECTOR_BANK1_CNT - 1); 
    } else {
        status = FLASHIAP_BlankCheckSector(NV_FLASH_USER_DATA_SECTOR_BANK2_OFFSET,NV_FLASH_USER_DATA_SECTOR_BANK2_OFFSET + NV_FLASH_USER_DATA_SECTOR_BANK2_CNT - 1); 
    }
